...
contract CC is IBEP20, Auth {
    ...
    string private constant  _name = "CC";
    ...
    uint256 private initialBlockLimit = 15;
    ...
    constructor (
        ...
        distributor = new DividendDistributor(_presaler);
    ...
    function setFeeReceivers(address _teamReceiver) external onlyOwner {
